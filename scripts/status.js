...
const BOLD = '\x1b[1m';
const RESET = '\x1b[0m';
const ok = (label, value) => console.log(`  ${GREEN}✓${RESET} ${label}: ${value}`);
const warn = (label, value) => console.log(`  ${YELLOW}⚠${RESET} ${label}: ${value}`);
const fail = (label, value) => console.log(`  ${RED}✗${RESET} ${label}: ${value}`);
function readEnv() {
